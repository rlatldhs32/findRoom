...
public class RoomController {
    ...
    public List<RoomDTO>  getAllRooms(
        ...
        List<RoomDTO> allRooms = roomService.getAllRooms(x1, x2, y1, y2,sellingType,roomType);
    ...
    public List<RoomDTO>  getGoodRooms(@Parameter(description = "판매 type. 0:월세 , 1:전세 , 2:매매 ") @RequestParam(name = "sellingType",required = false) Integer sellingType,
        ...
        return roomService.getBestTopRooms(x1, x2, y1, y2,number,sellingType,roomType,minSize);
    }
